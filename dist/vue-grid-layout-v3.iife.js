...
var VueGridLayout = function(exports, vue) {
  "use strict";
  const domObjects = {
    init: init$3,
    document: null,
  ...
  function install(Vue2) {
    ...
    Object.keys(VueGridLayout2).forEach((name) => {
      Vue2.component(name, VueGridLayout2[name]);
    });
  }
  const plugin = {
    install
  ...
  exports.default = VueGridLayout2;
